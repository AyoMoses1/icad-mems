/**
 * Menu Service - IMS menu endpoint integration
 * GET /api/menu (optionally ?workspaceId=...) is the source of truth for what
 * the user can see in the app; sidebar and navigation use this to show menu items.
