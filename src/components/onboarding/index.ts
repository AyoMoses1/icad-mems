 ...
 * Pages to show onboarding status to users (pending review, rejected)
 */
export { OnboardingPendingPage } from "./OnboardingPendingPage";
export { OnboardingRejectedPage } from "./OnboardingRejectedPage";
